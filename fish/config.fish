...
set --export LANG "en_US.UTF8"
set --export DOTNET_CLI_TELEMETRY_OPTOUT "1"
set --export QT_SELECT "5"
set --export OMP_NUM_THREADS "12"
### ADDING TO THE PATH

set -e fish_user_paths
set -U fish_user_paths $HOME/.local/bin $HOME/Applications /opt/lampp /usr/lib/qt6/bin $fish_user_paths /opt/intel/oneapi/compiler/2021.4.0/linux/bin $HOME/.npm-global/bin
...
# Network
    ...
    alias editwifi="nm-connection-editor"
    alias wifi="nmtui"
